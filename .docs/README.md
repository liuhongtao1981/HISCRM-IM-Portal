...
├── 快速参考-系统文档.md               ← ⚡ 速查表 (配置+部署+结构)
│
├── README.md                         ← 本文件
├── architecture/                     ← 架构文档
├── _archived/                        ← 归档文档 (55 个)
│   ├── 15-共享路径配置系统.md        ← 详细: 路径配置
│   ├── 16-shared-库架构说明.md       ← 详细: 库设计
│   ├── 17-部署指南-环境配置系统.md   ← 详细: 部署指南
│   ├── 项目结构说明.md               ← 详细: 项目结构
│   ├── 最终成果总结.md               ← 详细: 成果总结
│   └── ... (50 个历史文档)
└── archive/                          ← 旧归档
...
**版本**: 2.5.0 | **最后更新**: 2025-10-20 | **总文档**: 10 份核心文档 + 55 份归档 = 65 份
...
- 🔧 调试工具 (1 份) - 爬虫调试完整指南
- ⚡ 参考快速查询 (2 份) - 系统导航和速查表
- 📦 归档文档 (55 份) - 历史记录、详细指南和成果总结

**文档组织方式**:
- **核心文档** (10 份) - 日常开发必读，保持最新和精简
- **详细文档** (5 份) - 深入学习，已归档供参考
