...
-- 迁移数据
INSERT INTO comments_new (id, account_id, platform_user_id, platform_comment_id, content, author_name, author_id, post_id, post_title, is_read, detected_at, created_at, is_new)
SELECT id, account_id, platform_user_id, platform_comment_id, content, author_name, author_id, post_id, post_title, is_read, detected_at, created_at, is_new FROM comments;
...
-- 迁移数据
INSERT INTO direct_messages_new (id, account_id, platform_user_id, platform_message_id, content, platform_sender_id, platform_sender_name, platform_receiver_id, platform_receiver_name, message_type, direction, is_read, detected_at, created_at, conversation_id)
SELECT id, account_id, platform_user_id, platform_message_id, content, platform_sender_id, platform_sender_name, platform_receiver_id, platform_receiver_name, message_type, direction, is_read, detected_at, created_at, conversation_id FROM direct_messages;
