  ...
  setTimeout(async () => {
    ...
    if (recentMessages.length > 0) {
      ...
      recentMessages.forEach((msg, i) => {
        ...
        console.log(`       昵称: ${msg.sender_nickname || '(无)'}`);
        console.log(`       头像: ${msg.sender_avatar ? '有' : '(无)'}`);
