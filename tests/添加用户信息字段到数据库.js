/**
 * �?direct_messages 表添�?sender_avatar �?sender_nickname 字段
 */
...
try {
  ...
  console.log('🔍 检查现有字�?');
  console.log(`  sender_avatar: ${hasAvatarField ? '�?已存�? : '�?不存�?}`);
  console.log(`  sender_nickname: ${hasNicknameField ? '�?已存�? : '�?不存�?}`);
  console.log('');
