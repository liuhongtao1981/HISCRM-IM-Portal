 ...
 * 修复数据库中评论时间戳的时区问题
 *
 * 问题: 抖音API返回的时间戳是UTC+8，但旧评论数据没有应用时区修正
 * 解决: 将所有评论的 createdAt 减去 8 小时 (28800秒)
 */
...
readline.question('⚠️  即将修改数据库！是否继续？(输入 yes 继续): ', (answer) => {
  ...
  try {
    ...
    console.log(`✅ 已更新 ${result.changes} 条评论数据\n`);
