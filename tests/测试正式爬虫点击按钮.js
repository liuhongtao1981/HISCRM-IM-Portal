...
async function testOfficialCrawler() {
  ...
  try {
    console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
    console.log('🚀 开始执行正式爬虫流�?);
    console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n');

    // 3. 调用正式�?crawlComments 函数
    ...
    if (result.discussions.length === 0) {
      console.log('�?讨论数量�?0！按钮点击可能未执行\n');
      console.log('可能原因:');
      console.log('  1. 选择的视频评论没有回�?);
      console.log('  2. 按钮选择器未匹配到元�?);
